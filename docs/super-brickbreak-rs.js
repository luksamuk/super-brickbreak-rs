...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_53c266d4dd92dbaa565f516a9c0af742f10d546c": function($0, $1, $2, $3) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);Module.STDWEB.from_js($0, (function(){($1). font = ($2)+ "px " + ($3);})());
            },
